...
const NgoRegistration = () => {
    ...
    const handleSubmit = async (e) => {
        ...
        try {
            const response = await axios.post('https://greenbridgeserver.onrender.com/api/v1/ngo/register/', formData);
        ...
        <div>
            ...
            <div style={styles.backgroundContainer}>
                <div style={styles.registrationContainer}>
                    <h1 style={styles.mainHeading}>Welcome to NGO Registration</h1>
                    <h3 style={styles.subHeading}>Join our platform to make a difference in waste management</h3>
                    ...
                    <form onSubmit={handleSubmit} autoComplete="off">
                        ...
                        <div style={styles.formGroup}>
                            <label style={styles.formLabel}>NGO Name</label>
                            <input
                                type="text"
                                name="name"
                                value={formData.name}
