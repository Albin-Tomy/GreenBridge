...
const ProductDetail = () => {
  ...
  useEffect(() => {
    ...
    axios.get(`https://greenbridgeserver.onrender.com/api/v1/products/details/${id}/`)
      .then(response => {
    ...
    if (userId) {
      axios.get(`https://greenbridgeserver.onrender.com/api/v1/orders/cart-items/?user_id=${userId}`)
        .then(response => {
    ...
    axios.get('https://greenbridgeserver.onrender.com/api/v1/products/category-list/')
      .then(response => {
    ...
    axios.get('https://greenbridgeserver.onrender.com/api/v1/products/madeof-list/')
      .then(response => {
    ...
    axios.get(`https://greenbridgeserver.onrender.com/api/v1/orders/wishlist-list/?user_id=${userId}`)
      .then(response => {
        ...
        if (response.data.length > 0) {
          ...
          return axios.post('https://greenbridgeserver.onrender.com/api/v1/orders/wishlist-list/', { user_id: userId })
            .then(response => {
      ...
      .then(wishlistId => {
        return axios.post('https://greenbridgeserver.onrender.com/api/v1/orders/wishlist-items-create/', {
