...
const UserProfile = () => {
  ...
  useEffect(() => {
    const fetchProfile = async () => {
      try {
        const response = await axios.get(`https://green-bridge.onrender.com/api/v1/auth/user_profiles/${userId}/`, {
          headers: {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      const response = await axios.put(`https://green-bridge.onrender.com/api/v1/auth/user_profiles/update/${userId}/`, profile, {
        headers: {
          Authorization: `Bearer ${token}`
        }
      });
      ...
      if (error.response && error.response.status === 404) {
        ...
        try {
          await axios.post(`https://green-bridge.onrender.com/api/v1/auth/user_profiles/`, {
            user: userId,
            ...profile
          }, {
            headers: {
