...
const AddOrderForm = ({ onCancel, initialOrderData, isEdit }) => {
  ...
  const handleSubmit = (e) => {
    ...
    if (isEdit) {
      ...
      axios
        .put(`https://albintomy.pythonanywhere.com/api/v1/orders/update/${initialOrderData.order_id}/`, formData, {
          headers: {
      ...
      // Create a new order
      axios
        .post('https://albintomy.pythonanywhere.com/api/v1/orders/list/', formData, {
          headers: {
            'Content-Type': 'multipart/form-data',
          },
        })
