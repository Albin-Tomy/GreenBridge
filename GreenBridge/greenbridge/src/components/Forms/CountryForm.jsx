...
const AddCountryForm = ({ onCancel, initialCountryData, isEdit }) => {
  ...
  const checkCountryExists = async (name) => {
    try {
      ...
      const response = await axios.get("https://greenbridgeserver.onrender.com/api/v1/products/country-list/");
  ...
  const handleSubmit = async (e) => {
    ...
    const request = isEdit
      ? axios.put(
          `https://greenbridgeserver.onrender.com/api/v1/products/country-update/${initialCountryData.country_id}/`,
          formData
        )
      : axios.post("https://greenbridgeserver.onrender.com/api/v1/products/country-create/", formData);
