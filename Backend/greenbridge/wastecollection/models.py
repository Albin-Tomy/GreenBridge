...
class Request(models.Model):
    ...
    collection_status = models.BooleanField(default=False)  # Collection Status (True/False)
    ...
    def __str__(self):
        return f"Request {self.id} by {self.user.username}, Status: {self.request_status}"
