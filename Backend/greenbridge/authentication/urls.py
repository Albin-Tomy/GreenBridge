...
from .views import user_profile_detail, user_profile_update,create_user_profile,google_sign_in,delete_user,verify_email
...
urlpatterns = [
    ...
    path('google-signin/', google_sign_in, name='google-signin'),
