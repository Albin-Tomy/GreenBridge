...
urlpatterns = [
    ...
    # path('wishlist-list/', views.wishlist_list_create, name='wishlist_list_create'),
    # path('wishlist-detail/<int:pk>/', views.wishlist_detail, name='wishlist_detail'),
    # path('wishlist-items-list/', views.wishlist_items_list_create, name='wishlist_items_list_create'),
    # path('wishlist-items-detail/<int:pk>/', views.wishlist_items_detail, name='wishlist_items_detail'),
